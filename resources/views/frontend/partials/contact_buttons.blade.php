...
<div class="fixed right-5 bottom-5 z-50 flex flex-col space-y-3 items-center">
    ...
    <!-- Move to Top Button -->
    <button id="moveToTopBtn" type="button" onclick="window.scrollTo({top: 0, behavior: 'smooth'})" aria-label="Lên đầu trang" class="group relative items-center justify-center w-12 h-12 md:w-14 md:h-14 rounded-full bg-charcoal hover:bg-taupe-oak text-white shadow-xl hover:scale-110 transition-all duration-300 cursor-pointer border border-border-subtle" style="display: none;">
